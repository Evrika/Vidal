...
V.mobile = {
	...
	createSearch : function(){
		var $obj = $('.mobile_menu'), $searchIcon = $('.mobile_menu_search_overlay'), $searchClose = $('.mobile_search_close'), $searchWrap = $('.mobile_search_hidden'), $form = $('.header-3, .header-4');
		$form.appendTo( '.mobile_search_wrap' );
		$searchIcon.click(function(){
			$('body').css('overflow','hidden');
			$searchWrap.fadeIn();
			$('#search_form .search-query').focus();
		});
